...
# Notes:
#
# The knight's health has no upper bound. Any room can contain threats or power-ups, even the first room the knight
...
if __name__ == '__main__':
    ...
    print solution.calculate_minimum_HP(dungeon)
